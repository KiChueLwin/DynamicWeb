...
<head>
    ...
    <link rel="stylesheet" href="css/resetpassword.css?<?php echo time(); ?>">
...
<body>
    <div class="container p-5 d-flex flex-column align-items-center">
        ...
        <form action="" method="post" class="form-control mt-5 p-4">
            <div class="row">
                <i class="fa fa-user-circle-o fa-3x mt-1 mb-2" style="text-align: center; color: #ff4d4d;"></i>
                <h5 class="text-center p-4">Change Your Password</h5>
            </div>
            ...
            <div class="col mb-3 mt-3">
                <button type="submit" class="btn" style="background-color: #ff4d4d; color: white;">Reset Password</button>
            </div>
            <div class="col mb-2 mt-4">
                <p class="text-center"><a href="register-form.php">Create Account</a> OR <a href="login.php">Login</a></p>
            </div>
        </form>
