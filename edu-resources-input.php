...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO edu_resources (name, type, description, topic, audience, photo, video, file) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssssss", $name, $type, $description, $topic, $audience, $photo, $video, $file);
...
<head>
    ...
    <title>Educational Resources Input</title>
...
<body>
    <div class="content">
        <h2>Educational Resources Input</h2>
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="energy-topic">Energy Topic:</label>
                <select id="energy-topic" name="energy-topic" required>
