...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-dashboard" href="login.php" id="dashboard-btn">Login</a>
                    </li>
                    <li class="nav-item">
    ...
    <header class="home-contact text-white text-center">
        <div class="container">
            ...
            <p>Sign up now to explore our exclusive recipe collection!</p>
            <button class="join-us-button" data-bs-toggle="modal" data-bs-target="#registerModal" id="join-us-btn">Join
                Us as a Member</button>
                        ...
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    stroke-linejoin="round">
                                    <path d="M15 11h0.01"></path>
                                    <path d="M11 15h0.01"></path>
                                    <path d="M16 16h0.01"></path>
    ...
    <div id="cookie-consent-banner" class="cookie-consent-banner" style="display: none;">
        <p>This website uses cookies to improve your experience. By continuing to use this site, you consent to our use
            of cookies. <a href="#" id="cookie-rules-link">Read More</a></p>
        <button id="cookie-consent-button">Accept All Cookies</button>
    </div>

    <div id="cookie-rules-popup"
        style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color: white; padding: 20px; border: 1px solid #ccc; z-index: 1001; width: 80%; max-width: 600px;">
        <h2 class="cookie-rule-heading">Cookie Rules and Regulations</h2>
        <p>
            Here are our cookie policies and regulations. <br> Encourage users to submit original recipes. <br>When
            using existing recipes as inspiration, proper attribution is required (e.g., citing the original
            source).<br>Users are responsible for ensuring the accuracy of their recipes, including ingredient
            measurements and cooking instructions.<br>
            Recipes must not contain unsafe or harmful cooking methods or ingredients.<br>
            Disclaimers regarding allergies or dietary restrictions are recommended.<br>Recipe submissions should
            include clear and well-lit photos or videos of the finished dish.<br>
            This helps to create an engaging visual experience for other users.<br>
        </p>
        <button id="close-rules-popup">Close</button>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const cookieRulesLink = document.getElementById('cookie-rules-link');
            const cookieRulesPopup = document.getElementById('cookie-rules-popup');
            ...
            cookieRulesLink.addEventListener('click', function (event) {
                event.preventDefault(); // Prevent default link behavior
                cookieRulesPopup.style.display = 'block';
            });

            closeRulesPopup.addEventListener('click', function () {
                cookieRulesPopup.style.display = 'none';
            });
        });
    </script>
